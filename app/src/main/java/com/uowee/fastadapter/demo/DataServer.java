...
import com.uowee.fastadapter.demo.entity.Status;
...
public class DataServer {
    ...
    public static List<Movie> getSampleMovies() {
        return new Gson().fromJson(JSON_MOVIES, new TypeToken<ArrayList<Movie>>() {
        }.getType());
    }
    ...
    public static String JSON_MOVIES = "[" +
            ...
            "{\"actors\":\"莱昂纳多·迪卡普里奥|凯特·温丝莱特\",\"filmName\":\"泰坦尼克号\",\"grade\":\"10.0\",\"picaddr\":\"http://app.infunpw.com/commons/images/cinema/cinema_films/3757.jpg\",\"releasedate\":\"2017-08-04\",\"shortinfo\":\"大象参二战 一生好伙伴\",\"type\":\"动作|动画|战争|冒险\"}," +
