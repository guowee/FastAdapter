...
public interface RefreshKernel {
     ...
     * @return RefreshKernel
     */
    RefreshKernel requestNeedTouchEventFor(RefreshInternal internal, boolean request);
     ...
     * @return RefreshKernel
     */
    RefreshKernel requestDefaultTranslationContentFor(RefreshInternal internal, boolean translation);
     ...
     * @return RefreshKernel
     */
    RefreshKernel requestRemeasureHeightFor(RefreshInternal internal);
